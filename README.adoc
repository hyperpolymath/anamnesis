...
:experimental:
:url-github: https://github.com/hyperpolymath/Anamnesis
:url-gitlab: https://gitlab.com/hyperpolymath/Anamnesis
:url-bitbucket: https://bitbucket.org/hyperpolymath/Anamnesis
:url-codeberg: https://codeberg.org/hyperpolymath/Anamnesis

Memory and knowledge graph persistence layer
...
Anamnesis is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
